...
class CarSearchTests(TestCase):
    def setUp(self):
        ...
        Car.objects.create(model="Model S", manufacturer=Manufacturer.objects.create(name="Tesla", country="USA"))
...
class DriverSearchTests(TestCase):
    def setUp(self):
        ...
        Driver.objects.create(username="text", password="text", license_number="ABC1234", first_name="Imya", last_name="Familia")
        Driver.objects.create(username="test", password="test", license_number="XYZ7890", first_name="Imya", last_name="Familia")
        Driver.objects.create(username="shozadriver", password="shozadriver", license_number="LMN4567", first_name="Imya", last_name="Familia")

    def test_search_by_username(self):
        response = self.client.get(reverse("taxi:driver-list"), {"username": "text"})
        self.assertEqual(response.status_code, 200)
